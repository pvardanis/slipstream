...
class TestGoodputFraction:
    ...
    def test_is_goodput_over_throughput(self) -> None:
    ...
    def test_a_cell_that_completed_nothing_holds_no_goodput(self) -> None:
    ...
    def test_rejects_a_missing_or_non_numeric_metric(self, metric: str) -> None:
...
class TestClassifyFailures:
    ...
    def test_splits_timeout_from_other_by_the_error_string(self) -> None:
    ...
    def test_all_requests_succeeded_is_zero_of_every_cohort(self) -> None:
    ...
    def test_oom_is_not_captured_from_the_client_json(self) -> None:
    ...
    def test_failures_without_a_detailed_errors_array_fall_to_other(self) -> None:
    ...
    def test_a_non_string_errors_entry_is_rejected(self) -> None:
...
class TestCeiling:
    ...
    def test_is_the_highest_rung_above_the_floor(self) -> None:
...
class TestReadCell:
    ...
    def test_reads_the_rung_share_goodput_and_cohorts(self, tmp_path: Path) -> None:
    ...
    def test_rejects_a_cell_missing_its_join_key(
    ...
    def test_an_unreadable_file_raises_result_error(self, tmp_path: Path) -> None:
...
class TestAggregate:
    ...
    def test_one_row_per_point_and_share_with_the_ceiling(self, tmp_path: Path) -> None:
    ...
    def test_sums_failure_cohorts_across_a_group_ladder(self, tmp_path: Path) -> None:
    ...
    def test_rows_sort_by_point_then_share(self, tmp_path: Path) -> None:
    ...
    def test_ignores_a_non_point_subdir_and_the_ledger(self, tmp_path: Path) -> None:
